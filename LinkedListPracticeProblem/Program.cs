...
while (check)
{
    ...
    switch (Option)
    {
        ...
        case 8:
            UC8DeleteParticularElementOfLinkedList list7 = new UC8DeleteParticularElementOfLinkedList();
            int search = list7.Search(40);
            list7.LinkedListSize();
            list7.Display();
            list7.DeleteNodeAtPerticularPosition(search);
            list7.LinkedListSize();
            list7.Display();
            break;
